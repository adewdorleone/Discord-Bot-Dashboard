  ...
  run: async (client, message, args) => {
    ...
    const buttons = new MessageActionRow().addComponents(
      new MessageButton()
        .setLabel('Invite Me')
        .setStyle('LINK')
        .setURL('https://discord.com/oauth2/authorize?client_id=1006996302623690794&permissions=8&scope=bot%20applications.commands'),
      new MessageButton()
...
***LINKS***
﹒If you love my work, make sure to [star my repo](https://discord.com/oauth2/authorize?client_id=1006996302623690794&permissions=8&scope=bot%20applications.commands)
